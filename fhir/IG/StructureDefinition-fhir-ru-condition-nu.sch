...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition/f:clinicalStatus">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-condition-clinicalstatus']) &lt;= 1">extension with URL = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-condition-clinicalstatus': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition/f:bodySite">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-condition-bodysite-laterality']) &lt;= 1">extension with URL = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-condition-bodysite-laterality': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:text) &lt;= 1">text: maximum cardinality of 'text' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
