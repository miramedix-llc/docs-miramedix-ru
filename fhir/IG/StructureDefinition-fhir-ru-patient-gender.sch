...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:gender">
      ...
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-nsi-gender']) &gt;= 1">extension with URL = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-nsi-gender': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-nsi-gender']) &lt;= 1">extension with URL = 'http://fhir.ru/fhir/Extension/fhir-ru-ext-nsi-gender': maximum cardinality of 'extension' is 1</sch:assert>
