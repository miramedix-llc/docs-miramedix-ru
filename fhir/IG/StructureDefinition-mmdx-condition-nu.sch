...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Condition">
      ...
      <sch:assert test="count(f:extension[@url = 'http://miramedix.ru/fhir/Extension/mmdx-ext-condition-histology']) &lt;= 1">extension with URL = 'http://miramedix.ru/fhir/Extension/mmdx-ext-condition-histology': maximum cardinality of 'extension' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
