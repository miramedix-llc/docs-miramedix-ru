...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:gender">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://miramedix.ru/fhir/Extension/mmdx-ext-nsi-gender']) &gt;= 1">extension with URL = 'http://miramedix.ru/fhir/Extension/mmdx-ext-nsi-gender': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://miramedix.ru/fhir/Extension/mmdx-ext-nsi-gender']) &lt;= 1">extension with URL = 'http://miramedix.ru/fhir/Extension/mmdx-ext-nsi-gender': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:value) &lt;= 1">value: maximum cardinality of 'value' is 1</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
