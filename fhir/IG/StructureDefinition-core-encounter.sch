...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Encounter/f:diagnosis">
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-type']) &lt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric']) &gt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric']) &lt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-type']) &lt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-type': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric']) &gt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric']) &lt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-rubric': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://fhir.ru/core/sd/core-ex-diagnosis-type']) &lt;= 1">extension with URL = 'http://fhir.ru/core/sd/core-ex-diagnosis-type': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Encounter/f:diagnosis/f:extension</sch:title>
    <sch:rule context="f:Encounter/f:diagnosis/f:extension">
  ...
  <sch:pattern>
    <sch:title>Encounter.diagnosis.extension.extension</sch:title>
    <sch:rule context="f:Encounter/f:diagnosis/f:extension/f:extension">
  ...
  <sch:pattern>
    <sch:title>Encounter.diagnosis.extension.value[x] 1</sch:title>
    <sch:rule context="f:Encounter/f:diagnosis/f:extension/f:value[x]">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
